...
2. Read `README.md`, then `screening-config.yaml`, `universe.csv`, `research-notes.md`, and the latest `screen-results.csv` in that order. Record the data timestamp and note any missing or stale inputs.
